...
namespace LinqExercises.Controllers
{
    public class CustomersController : ApiController
    {
        ...
        public IHttpActionResult GetAll(string city)
        {
            ...
            var customersInCity = from customer in _db.Customers
                                  where customer.City.Contains(city)
                                  select customer;
            return Ok(customersInCity);
        }
        ...
        public IHttpActionResult GetAllFromMexicoSwedenGermany()
        {
            ...
            var customersFrMexSweGer = _db.Customers.Where(c => c.Country.Contains("Mexico") ||
                                                                c.Country.Contains("Sweden") ||
                                                                c.Country.Contains("Germany"));
            return Ok(customersFrMexSweGer);
        }
